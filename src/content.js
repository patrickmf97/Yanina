export const content = {
  es: {
    ...
    frase:
      "Un espacio para escucharte, comprenderte y trabajar en aquello que hoy necesitás.",
    ...
    especialidades: [
      {
        ...
        desc: "Acompañamiento en procesos de ansiedad, estrés y malestar emocional.",
      },
      {
        titulo: "Atención personalizada",
        desc: "Un espacio pensado para vos, a tu ritmo y sin juicios.",
      },
      {
        titulo: "Crecimiento personal",
        desc: "Herramientas para el autoconocimiento y la toma de decisiones.",
      },
    ],
    agendaTitulo: "¿Lista para dar el primer paso?",
    agendaTexto:
      "Las sesiones son por videollamada, con horarios flexibles. Elegí el mejor día para vos.",
  ...
  pt: {
    ...
    titulo: "Psicóloga · Paraná, Entre Ríos 🇦🇷",
    frase:
      "Um espaço para te ouvir, te compreender e trabalhar naquilo que você precisa hoje.",
    ...
    especialidades: [
      {
        ...
        desc: "Acompanhamento em processos de ansiedade, estresse e mal-estar emocional.",
      },
      {
        titulo: "Atendimento personalizado",
        desc: "Um espaço pensado para você, no seu ritmo e sem julgamentos.",
      },
      {
        titulo: "Crescimento pessoal",
        desc: "Ferramentas para o autoconhecimento e a tomada de decisões.",
      },
    ],
    agendaTitulo: "Pronta para dar o primeiro passo?",
    agendaTexto:
      "As sessões são por videochamada, com horários flexíveis. Escolha o melhor dia para você.",
